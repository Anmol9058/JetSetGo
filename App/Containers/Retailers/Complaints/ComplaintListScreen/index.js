...
<Complaintcard
data={item}
date={HelperService.dateReadableFormat(item.date_raised__c)}
ticketno={item.name}
dark={false}
...
/>
    ...
    getDataNode() {
        const {
          ...
          if (complaintdata.Pending&&complaintdata.Pending.length) {
  
          
          
             let filteredClaimList=complaintdata.Pending
